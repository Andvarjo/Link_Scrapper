...
class Scrapper(object):
    ...
    def obtener_imagen(self, url: str):
        ...
        if imagen_tag:
            ...
            imagen_url = 'https://img.freepik.com/vector-premium/icono-error-minimo-moderno-no-encontrado-vaya-pagina-no-encontrada-404-error-pagina-no-encontrada-concept_599740-716.jpg'
        return imagen_url